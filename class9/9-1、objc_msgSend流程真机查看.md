...
当前真机动态汇编方式探索了方法插入缓存和容器扩容方式，也可使用重写源码方式( 参考《6-2》)，对源码进行重写，然后进行相关类和数据的打印输出，此方式也能验证方法插入容器的逻辑

> 此扩展在 《20210630-大师班-第10节课-消息动态决议》
>
> 课后答疑时间 02:44:50 - 03:20:30 中使用此方式进行验证了，可观看和模拟该方式
